...
This paper develops and applies a public-source fundamental valuation framework for Indian listed companies. The framework is designed for early-career analysts, finance students, and independent researchers who want to move beyond basic stock screening toward a disciplined research workflow. The paper applies the framework to ten Indian listed companies across autos, pharmaceuticals, metals, refining, agrochemicals, industrial packaging, auto components, and capital goods. The selected companies are Hero MotoCorp, Natco Pharma, National Aluminium Company (NALCO), Hindustan Zinc, Chennai Petroleum Corporation (CPCL), Sharda Cropchem, Fiem Industries, Time Technoplast, Force Motors, and Triveni Turbine.
...
2. To explain how the sample companies were selected through fundamental screening and analyst judgement.
3. To apply the framework to ten Indian listed companies across different sectors.
4. To examine how DCF assumptions differ by sector and business model.
5. To identify the key valuation risks for each sector.
6. To design a reproducible Python/Excel workflow for valuation documentation and dashboarding.
7. To distinguish complete public-source research from institutional-grade audited research.
...
1. How can fundamental screening and Piotroski-style quality filters help narrow an Indian equity research universe?
2. How should DCF assumptions be normalized across different Indian sectors?
3. What are the main sector-specific valuation risks in Indian equities?
4. How can WACC and company-specific risk premiums be documented transparently in a public-source research project?
5. How can peer comparison be used as a valuation sanity check without replacing intrinsic valuation?
6. What data limitations remain when using public sources instead of audited institutional databases?
7. How can Python and Excel automation improve reproducibility in equity research documentation?
...
**H3:** A screening process that combines valuation, profitability, growth, balance-sheet strength, cash-flow discipline, and Piotroski-style quality indicators can improve sample selection for deeper valuation research.

**H4:** Public-source research can reach a useful portfolio and interview-grade standard when assumptions, sources, and limitations are documented clearly, but it cannot be considered fully institutional-grade without audited data reconciliation and market-data validation.

**H5:** A reproducible Python/Excel workflow improves the consistency and auditability of equity research outputs.

# 3. Literature and Conceptual Background

The paper is grounded in several established areas of finance: fundamental analysis, discounted cash flow valuation, cost of capital estimation, relative valuation, portfolio construction, and financial statement analysis. Classic portfolio and valuation literature emphasizes that value is driven by expected cash flows, risk, and growth. Discounted cash flow valuation links future cash flows to present value by discounting them at an appropriate rate. Relative valuation compares companies using market multiples, but such comparisons are meaningful only when peers share similar business models, risk profiles, growth prospects, and accounting quality.

Markowitz's portfolio theory established the importance of risk and return trade-offs in security selection and portfolio construction. Sharpe's capital asset pricing model provided a framework for relating expected return to systematic risk. Fama and French expanded the discussion of equity returns by identifying additional risk factors beyond market beta. In company valuation practice, DCF analysis remains central because it forces explicit assumptions regarding growth, margin, reinvestment, and risk. However, DCF outputs are highly sensitive to input assumptions, particularly terminal value, WACC, margin, and growth.
...
## 4.2 Sample Construction and Screening Logic

The company universe was not selected randomly. The starting point was a practical fundamental stock-screening process designed to identify Indian listed companies that could be evaluated through a combination of value, quality, growth, balance-sheet strength, and cash-flow discipline. The screening logic used public stock-screening variables and was then refined through qualitative business-model review.

The screening dimensions included:

1. **Valuation discipline:** price-to-earnings ratio, price-to-book ratio, enterprise value to operating earnings where available, and PEG-style interpretation where growth data were meaningful.
2. **Profitability and quality:** return on equity, return on capital employed, operating margin, net profit margin, and consistency of profitability.
3. **Growth profile:** sales growth, profit growth, business reinvestment capacity, and whether growth appeared cyclical, structural, or one-off.
4. **Balance-sheet strength:** debt-to-equity, interest coverage, liquidity profile, and whether leverage could distort equity value.
5. **Cash-flow discipline:** operating cash flow, free cash flow, working-capital behaviour, and whether accounting profit translated into cash.
6. **Piotroski-style quality check:** profitability, leverage/liquidity, and operating-efficiency indicators were used as a quality filter rather than a mechanical final selection rule.
7. **Liquidity and market sanity check:** market capitalization, trading liquidity, and abnormal price/volume behaviour were reviewed to avoid extremely illiquid or speculative cases.

The screening stage was followed by analyst judgement. Companies were included only if they provided a useful research lesson for the valuation framework. For example, NALCO and Hindustan Zinc were useful for commodity-cycle normalization, CPCL for GRM normalization, Sharda Cropchem for working-capital analysis, Force Motors for exceptional-item normalization, and Triveni Turbine for order-book and margin-sustainability analysis.

## 4.3 Barbell Research Design

The final sample was structured using a barbell research design rather than a single style category. The first side of the barbell contains core value or quality companies, where the research focus is downside discipline, normalized cash flows, and balance-sheet strength. The second side contains growth or satellite companies, where the research focus is growth optionality, operating leverage, product mix, execution risk, and margin sustainability.

| Barbell Category | Companies | Research Role |
|---|---|---|
| Core value / quality | Hero MotoCorp, Natco Pharma, NALCO, Hindustan Zinc, CPCL, Sharda Cropchem | Tests valuation discipline, normalization, balance-sheet strength, and downside-risk thinking |
| Growth / satellite | Fiem Industries, Time Technoplast, Force Motors, Triveni Turbine | Tests growth optionality, operating leverage, execution risk, and margin sustainability |

This design makes the paper more than a stock-selection exercise. It allows the research to compare how valuation assumptions change across defensive, cyclical, commodity-linked, and growth-oriented business models.

## 4.4 Sector Coverage

The companies were selected to create diversity across business models rather than statistical representativeness. The sample includes autos, pharmaceuticals, metals, refining, agrochemicals, industrial packaging, auto components, and capital goods. This design allows the framework to demonstrate how valuation assumptions change across sectors.
...
## 4.6 Data-Quality Classification
...
The methodology combines screening, intrinsic valuation, relative valuation, risk analysis, and reproducible documentation. The workflow begins with fundamental screening and business understanding, then moves to industry context, growth drivers, financial performance, DCF assumptions, WACC, peer framework, scenarios, sensitivity analysis, risk matrix, source log, and completion audit.

## 5.2 Screening and Piotroski-Style Quality Lens

The screening stage is used to narrow the universe, not to produce a final recommendation. Screening variables include valuation ratios, profitability ratios, growth indicators, balance-sheet strength, cash-flow conversion, and liquidity. A Piotroski-style lens is used to strengthen the quality discipline by reviewing profitability, leverage/liquidity, and operating-efficiency indicators.

The purpose of this stage is to reduce the probability of analysing companies that look statistically cheap but are financially weak, structurally impaired, or too illiquid for serious research. However, the screening result is only the starting point. Each selected company still requires company-specific research and DCF normalization.

## 5.3 FCFF DCF Framework
...
## 5.9 Barbell Valuation Logic

The barbell framework separates the sample into core value/quality companies and growth/satellite companies. Core companies are evaluated with stronger emphasis on downside protection, normalized earnings, balance-sheet resilience, and valuation discipline. Growth/satellite companies are evaluated with stronger emphasis on revenue runway, operating leverage, product mix, execution risk, and the sustainability of margins.

This approach does not imply portfolio weights or investment recommendations. It is used as a research-design lens to ensure that the framework can handle both value-oriented and growth-oriented valuation cases.

## 5.10 Python and Excel Implementation
...
The first finding is that stock screening is useful but incomplete. Screening ratios, Piotroski-style quality checks, and balance-sheet filters help narrow the company universe, but they do not replace company-specific valuation work. A screened company still requires business-model analysis, normalized cash-flow assumptions, and risk assessment.

The second finding is that the barbell research design improves coverage diversity. Core value/quality companies test downside discipline and normalized earnings, while growth/satellite companies test operating leverage, product optionality, and execution risk. This makes the framework broader than a single-style stock screen.

The third finding is that valuation logic is sector-specific. A generic DCF template is useful, but the assumptions must be adapted to the business model. Commodity companies require mid-cycle margins, refiners require normalized GRMs, pharmaceutical companies require product-cycle analysis, auto suppliers require customer-concentration assessment, and capital-goods companies require order-book analysis.

The fourth finding is that recent strong performance can mislead valuation. Many companies in the sample had strong recent results, but valuation requires separating sustainable earnings power from cyclical or one-off performance. This is especially important for commodity, refining, and auto-cycle businesses.

The fifth finding is that source and assumption logs improve transparency. By recording assumptions and data-quality limitations, the analyst makes the valuation process more reviewable. This helps avoid hidden assumptions and supports future audited-data refresh.

The sixth finding is that peer comparison is useful only when interpreted carefully. Peer multiples can provide context, but they should not replace business-model analysis. A company may deserve a different valuation multiple because of margin quality, cyclicality, capital intensity, leverage, or growth visibility.

The seventh finding is that Python and Excel automation can make research more reproducible. The project structure allows dashboards, DCF workbooks, beta regression, and peer templates to be refreshed systematically rather than manually recreated.
...
This paper developed a public-source fundamental valuation framework for Indian listed equities and applied it to ten companies selected through a combination of stock-screening filters, Piotroski-style quality checks, barbell research design, and business-model diversity. The study shows that a disciplined research workflow can improve transparency by combining DCF modelling, WACC frameworks, peer comparison, scenario analysis, sensitivity analysis, risk matrices, source logs, assumption logs, and Python/Excel automation.
...
# Appendix B. Screening and Sample Construction Logic

The initial company universe was developed through a practical stock-screening process. The screening process considered valuation, quality, profitability, growth, balance-sheet strength, cash-flow discipline, liquidity, and Piotroski-style indicators. The screening process was not treated as a mechanical buy/sell system. It was used to narrow the universe to companies that could support deeper valuation work.

| Screening Dimension | Examples of Variables Reviewed | Research Purpose |
|---|---|---|
| Valuation | P/E, P/B, EV/EBITDA where available, PEG-style interpretation | Identify companies that may deserve deeper valuation review |
| Profitability | ROE, ROCE, operating margin, net margin | Test business quality and capital efficiency |
| Growth | Sales growth, profit growth, sector growth drivers | Separate structural growth from cyclical or one-off growth |
| Balance sheet | Debt-to-equity, interest coverage, liquidity | Avoid value traps caused by financial stress |
| Cash flow | CFO, FCF, working-capital behaviour | Check whether accounting profits convert into cash |
| Piotroski-style quality | Profitability, leverage/liquidity, operating efficiency | Add quality discipline to the screening stage |
| Market sanity check | Liquidity, abnormal price/volume behaviour | Avoid extremely illiquid or speculative cases |

# Appendix C. Barbell Research Classification

| Category | Companies | Main Research Purpose |
|---|---|---|
| Core value / quality | Hero MotoCorp, Natco Pharma, NALCO, Hindustan Zinc, CPCL, Sharda Cropchem | Test downside discipline, normalized earnings, balance-sheet strength, and valuation conservatism |
| Growth / satellite | Fiem Industries, Time Technoplast, Force Motors, Triveni Turbine | Test revenue growth, operating leverage, product optionality, execution risk, and margin sustainability |

The barbell framework was used as a research classification tool. It was not used to make portfolio allocation recommendations.

# Appendix D. Data-Quality Classification
...
# Appendix E. Reproducibility Files
